...
# Printer Functions
printpage() {
    lp -o media=A4 -o resolution=1200dpi -o sides=two-sided-long-edge -d Brother_MFC-L2710DN_series $1
}

print2page() {
    lp -o media=A4 -o resolution=1200dpi -o sides=two-sided-long-edge -o number-up=2 -d Brother_MFC-L2710DN_series $1
}
